...
export function createNodesForSRSMini(docNode:SmoresNode) {
  ...
  const path_2 = docNode.newItem("heading", "Overall description");
  const node_2 = new SmoresNode(path_2!);
  node_2.newItem("comment", "Give an overview of what this software should do / how it fits into any larger system (i.e. if this is one component of a planned system, show how it fits into the larger scheme).");
  const path_3 = docNode.newItem("heading", "Software Requirements");
  const node_3 = new SmoresNode(path_3!);
