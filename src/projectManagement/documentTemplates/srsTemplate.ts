...
export function createNodesForSRSMini(docNode:SmoresNode) {
  ...
  const path_2 = newHeading(docNode, "Overall description");
  const node_2 = new SmoresNode(path_2!);
  newComment(node_2, "Give an overview of what this software should do / how it fits into any larger system (i.e. if this is one component of a planned system, show how it fits into the larger scheme).");
  const path_3 = newHeading(docNode, "Software Requirements");
  const node_3 = new SmoresNode(path_3!);
